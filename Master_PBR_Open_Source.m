...
% Information to print heat fluxes
        ...
        [M_Evap(i,1), evaporation_ht(i,1)] = Evaporative_HT_PBR(depth_pbr, width_pbr, TR_pbr(i,1), Tamb(i,1), RH(i,1), WNDSPD(i,1), dyn_visc_air, rho_air);
        ...
        Water_consump(i,1) = M_Evap(i,1)*depth_pbr*width_pbr*dt; %[kg/m2*s]*[m2]*[3600 s] = [kg/hr]
