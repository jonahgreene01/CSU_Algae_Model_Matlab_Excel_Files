...
I_ave_culture(i,1) = GHI(i,1) * 0.458 * Conc_eff(i,1); 
...
I_ave_ORP = I_ave_culture(n1:n2,1);

%Plot Temporally Resolved Outputs into Excel
Temporal_Outputs = [T_amb_Plot, TR_Plot, CX_plot, CO2_hourly_kg, Water_con, Ammonia_con, DAP_con, I_ave_ORP];
